...
$ ansible node1:node2 -m shell -a "echo Hello Clarusway > /home/ubuntu/testfile3"
```
...
```bash
$ ansible node1 -b -m shell -a "yum -y update ; yum -y install nginx ; service nginx start; systemctl enable nginx" 
``` 
...
- Visit the Ubuntu server's ip address on the browser. 
